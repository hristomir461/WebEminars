...
{
    public class WebEminarReportDeleteModel : IMapFrom<Data.Models.Report>, IHaveCustomMappings
    {
        ...
        public string WebEminarAddedByUserId { get; set; }
        ...
        {
            configuration.CreateMap<Data.Models.Report, WebEminarReportDeleteModel>()
